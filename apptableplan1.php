...
<body>
    <div class="container-fluid my-2">
        <div class="row">
            <div class="col-3">
                <select class="form-select" id="io_year">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-floating">
                                <input name="year" class="form-control my-3" placeholder="2023">
                                <label for="floatingInput">Year of Holidays</label>
                            </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function countBusinessDay(endDate, holidays = []) {
            let startDate = new Date().toISOString().slice(0, 10);
            let businessDays = 0;
            let daysLate = 0;

            while (startDate < endDate) {
                let weekday = new Date(startDate).getUTCDay();

                if (weekday < 6 && !holidays.includes(startDate)) { // Monday to Friday, not a holiday
                    businessDays++;
                }

                startDate = new Date(new Date(startDate).getTime() + 24 * 60 * 60 * 1000).toISOString().slice(0, 10);
            }
            ...
            if (startDate > endDate) { // if end date is in the past
                ...
                if (weekday < 6 && !holidays.includes(startDate)) { // Monday to Friday, not a holiday
                    businessDays--;
                    daysLate = Math.round((new Date(startDate) - new Date(endDate)) / (24 * 60 * 60 * 1000)); // calculate number of days late
                }
            }
